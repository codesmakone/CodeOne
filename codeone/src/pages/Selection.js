...
import Selection4 from '../components/Selection_4'
  ...
  return (
    <div className='container mx-auto px-5 xl:px-0'>
      ...
      <div className='my-5'>
        ...
        <p>
          The selection will consist of 2 parts: a coding task (10th September 2022- 11th September 2022) and an interview. You will only be invited to the interview if you successfully submit the coding task.
        </p>
      </div>
        <hr/>      
      <div className='my-5'>
      ...
      <div className='my-5'>
        ...
        <p>
        The submission deadline for the coding task is 00:59 WIB on the 11th September 2022. Any submissions later than that will not be accepted.
        </p>
      </div>
        <hr/>
      <Selection1/>

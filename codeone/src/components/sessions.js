    ...
    return(
        <div>
            <div className="my-5" id="description">
                ...
                <h6  className="text-base font-bold">Session 1 (13 September): Introduction To HTML and CSS</h6>
                ...
                <br/>
                <h6  className="text-base font-bold">Session 2 (20 September): Adding Functionalty With Javascript</h6>
                ...
                <br/>
                <h6  className="text-base font-bold">Session 3 (27 September): Powering Up With React</h6>

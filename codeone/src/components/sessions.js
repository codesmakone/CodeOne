    ...
    return(
        <div>
            <div className="my-5" id="description">
                ...
                <h6  className="text-base font-bold">Session 1 (26 August): Introduction To HTML and CSS</h6>
                ...
                <br/>
                <h6  className="text-base font-bold">Session 2 (02 September): Adding Functionalty With Javascript</h6>
                ...
                <br/>
                <h6  className="text-base font-bold">Session 3 (09 September): Powering Up With React</h6>

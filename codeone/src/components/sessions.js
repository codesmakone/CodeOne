...
const Sessions = () =>{
    return(
        <div>
            <div className="my-5 font-light" id="description">
                <h4 className="text-2xl font-medium mb-5">Brief Description Of Workshop Sessions</h4>
                <h6  className="text-base font-bold">Session 1 (... August): Introduction To HTML and CSS</h6>
                ...
                <br/>
                <h6  className="text-base font-bold">Session 2 (... August): Adding Functionalty With Javascript</h6>
                ...
                <br/>
                <h6  className="text-base font-bold">Session 3 (... August): Powering Up With React</h6>
